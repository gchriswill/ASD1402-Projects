// "TiQuery" and all "TiQuery add-ons" files are Custom Titanium Modules by Christopher "GchrisWill" Gonzalez (Twitter: @GchrisWill)...
// TiQuery version 4.0 (This version is an specific modified version with custom add-ons for local storage and remote API functionality to meet the ASD's Week 4 project...)
...
// Release Notes: 
// Lots of modifications from the people of the planet Kepler-22b, also thanks to the guardians of the galaxy... 
// Multiple add-ons files that manage a CRUD functionality of a local database with SQLite scripting and a new add-on for API network client requests...
// Also, SOME Functions UI classes on the main TiQuery file were omitted to improve performance on the week 4 app's structure from ASD at Full Sail University... Enjoy!


//Requirering custom TiQuery root CONTROLLER
var QController = require("TiQueryModule/TiQueryCONTROLLER");
